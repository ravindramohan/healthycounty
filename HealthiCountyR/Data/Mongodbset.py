...
def mongodbset():
        ...
        countiesRankJson = 'StatesCountiesRanks.json'
        Ranks = LoadJsonData(countiesRankJson)
        # Skip re creating the County Ranks if it is already created. 
        if ( Ranks == None or len(Ranks) == 0 ):
            Ranks = [
                        {
                            "State": "New York",
                            "FIPS": 36000,
        ...
        # Save the Rank Json file if it is the first time.
            with open(countiesRankJson, 'w') as f:
